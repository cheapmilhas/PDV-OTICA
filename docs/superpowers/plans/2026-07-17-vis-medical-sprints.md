...
- [ ] **T1.1 — Criar o cliente nº 1 limpo:** `Plan` para o Domus (**DECISÃO D1**: interno R$ 0 ou pago) + `Company` VIS_MEDICAL nova ("Clínica Domus Saúde") + `Subscription` ACTIVE. Não reaproveitar a casca de teste.
