...
describe("AdminSidebar", () => {
  it("renderiza a sidebar fixa do desktop com a marca", () => {
    const { container } = render(<AdminSidebar activeProduct="VIS_APP" canSeeFinance />);
  ...
  it("renderiza o botão hambúrguer do mobile", () => {
    render(<AdminMobileMenu activeProduct="VIS_APP" canSeeFinance />);
  ...
  it("o seletor nasce marcando o produto do cookie, não hardcode Vis App", () => {
    ...
    render(<AdminSidebar activeProduct="VIS_MEDICAL" canSeeFinance />);
